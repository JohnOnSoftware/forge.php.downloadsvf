...
class DataManagement{
    ...
    public function createOneBucket(){
      ...
      private function ExtractSVF( $urn, $accessToken){
        ...
        try {
            $result = $derivativeApi->getManifest($urn);
            print_r($result);
        } catch (Exception $e) {
      ...
      public function DownloadSVF( ){
        global $twoLeggedAuth;
        $accessToken = $twoLeggedAuth->getTokenInternal();
        $urn = "dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6cGhwc2FtcGxlYnVja2V0L3dvcmtzaG9wX2JpbV9waHAucnZ0";
        $this->ExtractSVF($urn, $accessToken);
      }    
